...
public class MEAURLFactory {
     ...
     * @return url
     */
    public String balanceInquiry(String token,String msisdn,String credentials){
        return String.format("%s/%s?token=%s&msisdn=%s&credentials=%s",BASE_URL,"balanceInquiry",token,msisdn,credentials);
    }
